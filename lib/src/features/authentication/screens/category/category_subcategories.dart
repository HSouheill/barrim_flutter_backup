...
class CategorySubcategoriesPage extends StatefulWidget {
  ...
  @override
  _CategorySubcategoriesPageState createState() => _CategorySubcategoriesPageState();
}
...
class _CategorySubcategoriesPageState extends State<CategorySubcategoriesPage> {
  ...
  void _navigateToSubcategory(String subcategory) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CategoryPlaces(categoryId: subcategory.toLowerCase().replaceAll(' ', '_')),
      ),
    );
  }
